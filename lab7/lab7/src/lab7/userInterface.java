 ...
 //       Proba p = new Proba();
        ...
        switch (choice)
        {
            ...
            //    p.showDirectedGraph(G);
                GenerateInterface show = new GenerateInterface();
                break;
            case 2:
                queryInterface Bri = new queryInterface();
                /**
                ...
                **/
                break;
            case 3:
                newTextInterface Text = new newTextInterface();
                /**
                ...
                break;
            case 4:
                routeInterface R = new routeInterface();
                /**
            ...
            //      G.noteDirectedGraph(G,path[0],path[1],G.Dijkstra(path[0], path[1]));
                ...
                break;
            case 5:
                RandomInterface walk = new RandomInterface(G);
